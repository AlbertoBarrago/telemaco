...
def main():
    ...
    for ours_path in sorted(out.glob("*.telemaco.png")):
        name = ours_path.name.removesuffix(".telemaco.png")
        ...
        fixture = {
            ...
            "behavior": {"telemaco": [], "chromium": []},
        }
        for engine, array in (("telemaco", ours), ("chromium", chromium)):
