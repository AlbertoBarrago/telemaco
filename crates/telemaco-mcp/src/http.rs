...
/// Origin allowlist for browser callers, read from `TELEMACO_MCP_ALLOWED_ORIGINS`
...
fn allowed_origins_env() -> Option<String> {
    std::env::var("TELEMACO_MCP_ALLOWED_ORIGINS")
        .ok()
...
async fn handle_connection(
    ...
    loop {
        ...
        // Origin gate: when TELEMACO_MCP_ALLOWED_ORIGINS is configured, a browser
