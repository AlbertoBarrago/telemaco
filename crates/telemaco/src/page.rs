...
use telemaco_browser::{InterceptedRequest, Page as InnerPage};
use telemaco_net::{RequestCallback, ResponseCallback};
use serde_json::Value;

use crate::error::Error;

/// Read a DOM node id from a JS `evaluate` result. telemaco serializes JS numbers
...
impl Page {
    ...
    /// [`telemaco::InterceptResolution`] (`Continue`, `Fulfill`, `Fail`) to pass,
