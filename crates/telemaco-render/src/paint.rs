...
/// implementation uses Telemaco's pooled image agent; tests and embedding
...
fn image_request_profile(tree: &DomTree, id: telemaco_dom::tree::NodeId) -> ImageRequestProfile {
    match tree
        .get_node(id)
...
fn image_resource_key(url: &str, profile: ImageRequestProfile) -> String {
    ...
    match profile {
        ...
        ImageRequestProfile::CorsSameOrigin => format!("\0telemaco-img-cors\0{url}"),
        ImageRequestProfile::CorsInclude => format!("\0telemaco-img-credentials\0{url}"),
    }
}
...
pub struct RenderResourceCache {
    ...
    max_entries: usize,
    max_bytes: usize,
    content_image_intrinsics: HashMap<telemaco_dom::tree::NodeId, RememberedContentImageIntrinsic>,
    content_image_intrinsic_order: VecDeque<telemaco_dom::tree::NodeId>,
...
impl RenderResourceCache {
    ...
    fn seed_content_image_intrinsics(
        &mut self,
        tree: &DomTree,
        intrinsic: &mut HashMap<telemaco_dom::tree::NodeId, crate::ReplacedIntrinsic>,
        selected: &mut HashMap<telemaco_dom::tree::NodeId, SelectedImage>,
    ) -> HashSet<telemaco_dom::tree::NodeId> {
        let remembered = self
    ...
    fn forget_content_image_intrinsic(&mut self, nid: telemaco_dom::tree::NodeId) {
...
pub trait CanvasSurfaceSource {
    fn surface(&self, node: telemaco_dom::tree::NodeId) -> Option<CanvasSurface<'_>>;
}

struct EmptyCanvasSurfaceSource;

impl CanvasSurfaceSource for EmptyCanvasSurfaceSource {
    fn surface(&self, _node: telemaco_dom::tree::NodeId) -> Option<CanvasSurface<'_>> {
        None
    }
}
...
impl ResolvedScrollState {
    ...
    fn movement_for(&self, id: telemaco_dom::tree::NodeId) -> (f32, f32) {
        self.node_movement
            .get(id.index())
            .copied()
            .unwrap_or((0.0, 0.0))
...
pub struct PreparedRender {
    ...
    viewport_fixed: std::collections::HashSet<telemaco_dom::tree::NodeId>,
    sticky: crate::StickyLayout,
    scroll_tree: crate::dom::ScrollTree,
    selected_images: HashMap<telemaco_dom::tree::NodeId, SelectedImage>,
...
impl PreparedRender {
    ...
    fn try_advance_visual_waapi_sample(
        ...
        let connected = |node: telemaco_dom::tree::NodeId| {
    ...
    pub fn viewport_fixed_nodes(&self) -> &std::collections::HashSet<telemaco_dom::tree::NodeId> {
        &self.viewport_fixed
    }
    ...
    pub fn scroll_container_nodes(&self) -> impl Iterator<Item = telemaco_dom::tree::NodeId> + '_ {
        self.scroll_tree
            .containers
            .iter()
            .skip(1)
    ...
    pub fn resolve_scroll_state(
        ...
        requested_elements: &HashMap<telemaco_dom::tree::NodeId, (f32, f32)>,
    ) -> ResolvedScrollState {
    ...
    pub fn document_rect(&self, id: telemaco_dom::tree::NodeId) -> Option<crate::Rect> {
    ...
    pub fn client_size(&self, id: telemaco_dom::tree::NodeId) -> Option<(f32, f32)> {
        let rect = self.layout.rects.get(&id)?;
    ...
    pub fn selected_image(&self, id: telemaco_dom::tree::NodeId) -> Option<&SelectedImage> {
...
fn retained_animation_restyle_mutations(
    tree: &DomTree,
    styles: &HashMap<telemaco_dom::tree::NodeId, crate::LayoutStyle>,
...
struct CanvasBackground {
    root: telemaco_dom::tree::NodeId,
    source: telemaco_dom::tree::NodeId,
}
...
fn paint_laid_dom_scrolled(
    ...
    paint_root: Option<telemaco_dom::tree::NodeId>,
    suppress_opacity_for: Option<telemaco_dom::tree::NodeId>,
    suppress_stacking_for: Option<telemaco_dom::tree::NodeId>,
    suppress_transform_for: Option<telemaco_dom::tree::NodeId>,
    clip_scope_root: Option<telemaco_dom::tree::NodeId>,
    ...
    let mut svg_subtree_skip: std::collections::HashSet<telemaco_dom::tree::NodeId> =
    ...
    let mut opacity_subtree_skip: std::collections::HashSet<telemaco_dom::tree::NodeId> =
        std::collections::HashSet::new();
    ...
    let mut neg_layers: Vec<(i32, Vec<telemaco_dom::tree::NodeId>)> = Vec::new();
    let mut pos_layers: Vec<(i32, Vec<telemaco_dom::tree::NodeId>)> = Vec::new();
    let mut float_layers: Vec<telemaco_dom::tree::NodeId> = Vec::new();
    let mut normal: Vec<telemaco_dom::tree::NodeId> = Vec::new();
    let mut consumed: std::collections::HashSet<telemaco_dom::tree::NodeId> =
        std::collections::HashSet::new();
    ...
    let paint_order: Vec<telemaco_dom::tree::NodeId> = neg_layers
        .into_iter()
        .flat_map(|(_, sub)| sub)
        .chain(normal)
        .chain(float_layers)
    ...
    if !laid.generated_boxes.is_empty() {
        let paint_indices: std::collections::HashMap<telemaco_dom::tree::NodeId, usize> =
            paint_order
                .iter()
                .enumerate()
                .map(|(index, &nid)| (nid, index))
                .collect();
        let mut last_index: std::collections::HashMap<telemaco_dom::tree::NodeId, usize> =
            paint_indices.clone();
...
struct ScrollPaintState<'a> {
    ...
    viewport: (f32, f32),
    scroll: (f32, f32),
    viewport_fixed: &'a std::collections::HashSet<telemaco_dom::tree::NodeId>,
    sticky: Arc<std::collections::HashMap<telemaco_dom::tree::NodeId, (f32, f32)>>,
    sticky_clips: Arc<std::collections::HashMap<telemaco_dom::tree::NodeId, (f32, f32)>>,
...
fn viewport_fixed_clip_map(
    ...
    laid: &crate::DomLayout,
    viewport_fixed: &std::collections::HashSet<telemaco_dom::tree::NodeId>,
    sticky: &std::collections::HashMap<telemaco_dom::tree::NodeId, (f32, f32)>,
) -> std::collections::HashMap<
    telemaco_dom::tree::NodeId,
    Option<crate::dom::OverflowClip>,
> {
...
fn selected_option_label(tree: &DomTree, select: telemaco_dom::tree::NodeId) -> Option<String> {
    let mut first = None;
...
fn collect_image_intrinsics(
    ...
    HashMap<telemaco_dom::tree::NodeId, crate::ReplacedIntrinsic>,
    HashMap<telemaco_dom::tree::NodeId, SelectedImage>,
) {
...
fn collect_content_image_intrinsics(
    tree: &DomTree,
    styles: &std::collections::HashMap<telemaco_dom::tree::NodeId, crate::LayoutStyle>,
    base_url: Option<&str>,
    cache: &mut RenderResourceCache,
    out: &mut std::collections::HashMap<telemaco_dom::tree::NodeId, crate::ReplacedIntrinsic>,
    selected: &mut HashMap<telemaco_dom::tree::NodeId, SelectedImage>,
    source_intrinsic: &HashMap<telemaco_dom::tree::NodeId, crate::ReplacedIntrinsic>,
    source_selected: &HashMap<telemaco_dom::tree::NodeId, SelectedImage>,
    seeded: &HashSet<telemaco_dom::tree::NodeId>,
) -> bool {
...
fn picture_source_url(
    tree: &DomTree,
    img_nid: telemaco_dom::tree::NodeId,
    viewport: (f32, f32),
) -> Option<(String, f32)> {
...
#[cfg(test)]
fn serialize_svg(tree: &DomTree, root: telemaco_dom::tree::NodeId) -> String {
...
fn serialize_svg_node(
    ...
    nid: telemaco_dom::tree::NodeId,
    is_root: bool,
    styles: Option<&std::collections::HashMap<telemaco_dom::tree::NodeId, crate::LayoutStyle>>,
...
mod tests {
    ...
    /// in telemaco-js. It checks that sticky backgrounds and descendants move
    ...
    fn paints_inline_svg_with_framework_colon_attribute() {
        let tree = telemaco_dom::parse_html(
