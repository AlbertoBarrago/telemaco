//! telemaco-render: the optional scoped render layer for Telemaco.
//!
//! Telemaco's default build has no layout or paint engine, which is the source
...
/// The display modes telemaco-render cares about for phase 1. Inline text layout
...
pub struct LayoutStyle {
    ...
    /// cells inherit it); telemaco applies it as main-axis alignment of the
...
pub struct WaapiAnimation {
    pub id: u64,
    pub node: telemaco_dom::tree::NodeId,
...
pub struct AnimationTimelineState {
    instances: std::collections::HashMap<telemaco_dom::tree::NodeId, AnimationInstance>,
    start_candidates: std::collections::HashMap<telemaco_dom::tree::NodeId, f32>,
    subtree_start_candidates: std::collections::HashMap<telemaco_dom::tree::NodeId, f32>,
...
impl AnimationTimelineState {
    ...
    pub fn materialize_start_candidates(&mut self, tree: &telemaco_dom::DomTree) {
    ...
    pub fn remove_subtree<'a>(
        &mut self,
        nodes: impl IntoIterator<Item = &'a telemaco_dom::tree::NodeId>,
    ) {
        for node in nodes {
    ...
    pub fn waapi_node(&self, id: u64) -> Option<telemaco_dom::tree::NodeId> {
    ...
    pub fn waapi_nodes(
        &self,
    ) -> std::collections::HashSet<telemaco_dom::tree::NodeId> {
    ...
    pub(crate) fn clear_animation(&mut self, node: telemaco_dom::tree::NodeId, sample: AnimationSample) {
    ...
    pub fn retain_nodes(
        &mut self,
        mut keep: impl FnMut(telemaco_dom::tree::NodeId) -> bool,
    ) {
